...
Просто скачайте архив и распакуйте в папку решения. Если у вас автоматически создался проект при создании решения, вы можете его удалить, так как он не понадобится вам.
...
```
Оно отвечает за класс сериалайзера, который будет использовать при **работе** над проектом. Сериалайзер, который отвечает за работу в билде, мы настроим позже.
...
> **Важно!** Рабочая директория проекта должна находиться в папке проекта, иначе программа будет по умолчанию брать путь `./bin/Debug/net10.0/`